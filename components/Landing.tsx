    ...
    <div className="flex flex-col items-center text-center py-10 space-y-12">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8 w-full">
        <FeatureCard 
          ...
          desc="সরাসরি নির্বাচন কমিশনের ডাটাবেসের সাথে সংযুক্ত অটোমেটেড সিস্টেম।" 
        />
        <FeatureCard 
          icon="👤" 
      ...
      <div className="bg-amber-50 border-l-4 border-amber-400 p-4 max-w-lg rounded">
        <p className="text-sm text-amber-800">
          <strong>সতর্কতা:</strong> আপনার এনআইডি এবং পাসওয়ার্ড গোপন রাখুন। এটি আপনার সাংবিধানিক অধিকার।
        </p>
      </div>
    </div>
  );
